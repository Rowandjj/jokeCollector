...
public class Joke
{
    public static final String FEATCH_URL = "http://jandan.net/?oxwlxojflwblxbsapi=jandan.get_duan_comments&page=";
    ...
    public Joke(String comment_ID, String comment_post_ID, String comment_author, String comment_author_email, String comment_author_url, String comment_author_IP, String comment_date, String comment_date_gmt, String comment_content, String text_content, String comment_agent, String vote_positive, String vote_negative, String comment_counts)
    {
        super();
    ...
    {
        return "DuanZi [comment_ID=" + comment_ID + ", comment_post_ID=" + comment_post_ID + ", comment_author=" + comment_author + ", comment_author_email=" + comment_author_email + ", comment_author_url=" + comment_author_url + ", comment_author_IP=" + comment_author_IP + ", comment_date=" + comment_date + ", comment_date_gmt=" + comment_date_gmt + ", comment_content=" + comment_content + ", text_content=" + text_content + ", comment_agent=" + comment_agent + ", vote_positive=" + vote_positive + ", comment_counts=" + comment_counts + ", vote_negative=" + vote_negative + "]";
    }
